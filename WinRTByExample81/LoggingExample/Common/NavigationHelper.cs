...
namespace LoggingExample.Common
{
    using LoggingHelper;
    ...
    public class NavigationHelper : DependencyObject
    {
        ...
        public NavigationHelper(Page page)
        {
            ...
            {
                LogEventSource.Log.Debug(string.Format("Page {0} loaded.", page.GetType().FullName));
            ...
            {
                LogEventSource.Log.Debug(string.Format("Page {0} unloaded.", page.GetType().FullName));
        ...
        public void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
                LogEventSource.Log.Debug(string.Format("New navigation: {0}", this._pageKey));
            ...
            else
            {
                ...
                if (this.LoadState != null)
                {
                    LogEventSource.Log.Debug(string.Format("Load state: {0}", this._pageKey));
