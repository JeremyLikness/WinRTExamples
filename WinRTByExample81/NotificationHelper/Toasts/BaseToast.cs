...
namespace WinRTByExample.NotificationHelper.Toasts
{
    ...
    public class BaseToast : BaseNotification<BaseToast>
    {
        ...
        public ScheduledToastNotification ScheduleAt(DateTime schedule)
        {            
        ...
        public ScheduledToastNotification ScheduleIn(TimeSpan timeSpan)
        {
            return this.ScheduleAt(DateTime.Now.Add(timeSpan));
        }        
    }
}
