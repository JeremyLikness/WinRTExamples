...
namespace AuthenticationExample.Auth
{
    ...
    public class GoogleAuthenticator : IAuthHelper, ICanLog 
    {
        ...
        /// Client id
        /// </summary>
        private const string ClientId = "{Your Client ID Goes Here}.apps.googleusercontent.com"; // https://code.google.com/apis/console/ API Access 

        /// <summary>
        /// The client secret.
        /// </summary>
        private const string ClientSecret = "{Your Client Secret Goes Here}"; // https://code.google.com/apis/console/ API Access
