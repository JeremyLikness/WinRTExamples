...
namespace DataFormatsExample
{
    ...
    public sealed partial class MainPage
    {
        ...
        {
            var file = await StorageFile.GetFileFromApplicationUriAsync(this.booksUri);
        ...
        {
            var xsltFile = await StorageFile.GetFileFromApplicationUriAsync(this.booksXslt);
            var xslt = await XmlDocument.LoadFromFileAsync(xsltFile);
            var processor = new XsltProcessor(xslt);
            var xmlFile = await StorageFile.GetFileFromApplicationUriAsync(this.booksUri);
