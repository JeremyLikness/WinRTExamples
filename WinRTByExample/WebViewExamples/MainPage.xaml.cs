...
namespace WebViewExamples
{
    ...
    public sealed partial class MainPage
    {
        ...
        /// <summary>
        /// The URL to Jeremy's blog post about a tiny IOC container
        /// </summary>
        ...
        {
            this.WebViewControl.LoadCompleted += this.WebViewControlLoadCompleted;
            this.WebViewControl.AllowedScriptNotifyUris = new List<Uri> { new Uri(JeremyBlog) };
